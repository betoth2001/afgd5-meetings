...
*/
function afgd5me_event_get($service,$calendarId, $event_id){
  $count=1;
  $event = afgd5me_event_get_repeater($service,$calendarId, $event_id);
...
/*
* This function makes a request to Google server for an event.
...
*/
function afgd5me_event_get_repeater($service,$calendarId, $event_id){
  try {
